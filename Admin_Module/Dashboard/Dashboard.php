...
if (isset($_GET['ajax_fetch'])) {
    ...
    $sql = "SELECT b.id AS booking_id,
                   COALESCE(u.name, CONCAT('User ID: ', b.user_id)) AS player_name,
    ...
    <main class="content">
        <header class="dashboard-header">
            ...
            <div class="header-actions">
                <br>
                <a href="../Superadmin/AdminManagement.php" class="action-btn"><i class="fas fa-user-plus"></i> Add Admin</a>
            </div>
            <?php endif; ?>
        </header>
        ...
        <section class="stats-grid">
            ...
            <?php if ($role === 'Superadmin' || $role === 'Admin'): ?>
                <a href="../Coaches_Management/ManageCoaches.php" class="stat-link">
                    <div class="stat-box">
            ...
            <a href="../Bookings_Management/ManageBookings.php" class="stat-link">
                <div class="stat-box">
