            ...
            <div style='font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px;'>
                <div style='max-width: 520px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);'>
                    ...
                    <div style='padding: 36px 32px;'>
                        ...
                        <p style='color: #64748b; font-size: 15px; line-height: 1.6; margin: 0 0 24px;'>Your coach account has been created on Smash Arena. Use the temporary credentials below to log in for the first time.</p>
...
<head>
    ...
    <title>Smash Arena - Coach Management</title>
